...
<head>
  ...
  <title>Advance Application-NOTES</title>
  <!-- Favicon -->
...
<div class="page-flex">
  ...
  <div class="container main-nav">
    ...
    <main class="main users chart-page" id="skip-target">
      <div class="container">
        <h2 class="main-title">Advance Application Development</h2>
        <?php
...
$query = "SELECT * FROM `notes`WHERE `subject`='AAD' ORDER BY `id` DESC; " ;
...
<td>{$rows['date']}</td>
<td>{$rows['person']}</td>
<td class='pt-3'> <a href='./n_view.php?id={$rows['id']}'><button type='button' class='btn btn-primary'>View</button></a></td>
